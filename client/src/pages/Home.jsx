                    ...
                    <div className="max-w-xl text-center sm:text-left">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4 text-center">
                            <button
                                ...
                                className="block w-full rounded bg-[#01005f] px-12 py-3 text-sm font-heading uppercase text-white shadow hover:bg-white hover:text-brand-blue duration-300 ease-in-out  sm:w-auto"
                            >
                                Get Started
                            </button>
                    ...
                    <div className="anoucement grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-3 ">
                        ...
                        <div className="btn_container flex items-center sm:justify-end justify-center">
                            ...
                            >
                                ...
                                <span className="text-sm font-medium transition-all text-brand-blue">
                                    Let's Sell Now!
                                </span>
                            </button>
                        </div>
