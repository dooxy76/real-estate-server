...
const Contact = ({ listing }) => {
    ...
    useEffect(() => {
        (async () => {
            setLoading(true)
            const res = await fetch(`${VITE_SERVER_URL}/api/users/${listing.userRef}`)
    ...
    const handleSendMsg = async () => {
        ...
        try {
            setSending(true)
            const res = await fetch(`${VITE_SERVER_URL}/api/conversation/create`, {
                method: 'POST',
            ...
            if (json.success === false) {
                ...
                const resMsg = await fetch(`${VITE_SERVER_URL}/api/message/create`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(
                        {
