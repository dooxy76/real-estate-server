...
const OfferedListing = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                setLoading(true)
                const res = await fetch(`${VITE_SERVER_URL}/api/posts?type=all&offer=true`)
        ...
        < section >
            ...
            >
                ...
                <div className="btn_container flex items-center justify-center">
                    <button
                        className="group relative inline-flex items-center overflow-hidden rounded bg-[#01005f] px-8 py-3 text-white "
