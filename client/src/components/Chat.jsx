...
const Chat = ({ conversationInfo }) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const res = await fetch(`${VITE_SERVER_URL}/api/message?sender=${trackConversation.sender}&receiver=${trackConversation.receiver}`)
    ...
    const handleSendMsg = async (e) => {
        ...
        sendMessageTOSocket();
        try {
            const sendMsgToDB = await fetch(`${VITE_SERVER_URL}/api/message/create`, {
                method: 'POST',
    ...
    const handleConversationDelete = async () => {
        try {
            const deleteChat = await fetch(`${VITE_SERVER_URL}/api/conversation/delete/${_id}`, {
                method: 'DELETE'
            });
            if (deleteChat.ok) {
